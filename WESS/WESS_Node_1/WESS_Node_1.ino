...
#define BLYNK_TEMPLATE_ID "TMPL0Zzof4z4"
#define BLYNK_TEMPLATE_NAME "WESS Node 1"
#define BLYNK_AUTH_TOKEN "tvCn6ZVpy9Jj0Jko_FbVWZaknarX7v0v"
...
void loop() {
  ...
  // Update dashboard
  Blynk.virtualWrite(V1,uidString);
  Blynk.virtualWrite(V2,userName);
}
